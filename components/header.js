    ...
    <div className="header">
      <div id='about' className="about-container">
        <div className="about-text">
          ...
          <p>
            Hey, I am Tom. Currently working as a Software Engineer at Applab Qatar. I work on Azure environments. Creating custom solutions for Azure Resources such as Cognitive Search, Azure Front Door and CDN, Azure Devops using Azure Functions or Azure App Service.
          </p>
        </div>
