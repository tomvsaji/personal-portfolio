...
In my previous post, I covered a year of building a SQL agent on top of a complex, legacy on-premises database — what worked, what hurt, and how the architecture evolved. That post covered the **why**. This one covers the **how**.
